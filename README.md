...
**TEexpress** provides a complete workflow for differential expression analysis 
...
**TEexpress** is designed to work with count tables generated by [TElocal](https://github.com/mhammell-laboratory/TEtranscripts) from the TEtranscripts package.
...
TEexpress uses a hierarchical classification system for TEs:
```
...
my.data <- downloadTestData(data_folder = "~/data/TEexpress_test")
```
...
If you use TEexpress in your research, please cite:

Peris Guillermo, TEexpress (2026). Github repository 
[https://github.com/GuillePeris/TEexpress](https://github.com/GuillePeris/TEexpress).
